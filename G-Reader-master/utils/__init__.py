...
from .dureader_eval import very_compute_bleu_rouge
from .dureader_eval import rabel_compute_bleu_rouge
from .dureader_eval import rouge_compute_bleu_rouge
...
__all__ = [
    ...
    'very_compute_bleu_rouge',
    'rabel_compute_bleu_rouge',
    'rouge_compute_bleu_rouge',
    ]
